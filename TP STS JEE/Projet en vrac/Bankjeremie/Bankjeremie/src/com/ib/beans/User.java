...
public class User {
    ...
    public static HashMap<String,String> getClientIDPassword(){
        /*
        cette fonction parcoure la bdd et retourne tous les couples ID/mdp de la bdd
        hashmap: email, password dans cet order là
        */
    ...
    public static HashMap<String,String> getClientIDAccess(){
		...
		//cette fonction parcoure la bdd et retourne tous les couples ID/Person_is_advisor
