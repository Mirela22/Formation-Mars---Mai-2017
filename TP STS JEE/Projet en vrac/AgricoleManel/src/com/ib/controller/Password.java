...
public class Password {
	...
	// Define the BCrypt workload to use when generating password hashes. 10-31 is a valid value.
		...
		public static void main(String[] args) {
			...
			BddConnect.ajoutUser(85632154, "SELVES", "Edouard", "ded@dmd.com", "edouard", "08/10/1992", "0000000000", 6);
			
			
	
			
			
			//UpdateUser(int client_id, String lastname, String firstname, String email, String password)
